...
#### 2. Denial of Wallet (DoW)
  Злоумышленники могут инициировать генерацию большого количества токенов, что потребует чрезмерного использования облачных ресурсов и приведёт к непосильным финансовым нагрузкам на поставщика.
#### 3. Переполнение непрерывного ввода
  Постоянная отправка входных данных, выходящих за рамки контекстного окна LLM, может привести к чрезмерному использованию вычислительных ресурсов, что приведет к ухудшению качества обслуживания и сбоям в работе.
...
#### Сценарий №4: Denial of Wallet (DoW)
  Злоумышленник заставляет модель генерировать чрезмерное количество токенов, чтобы израсходовать деньги за использование облачных ИИ-сервисов, вызывая непосильные расходы для поставщика сервиса.
