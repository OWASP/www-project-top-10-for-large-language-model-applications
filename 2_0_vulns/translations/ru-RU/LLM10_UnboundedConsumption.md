...
#### 2. Denial of Wallet (DoW)
    ...
    Злоумышленники могут инициировать большое количество операций, что потребует чрезмерного использования облачных ресурсов и приведёт к непосильным финансовым нагрузкам на поставщика.
