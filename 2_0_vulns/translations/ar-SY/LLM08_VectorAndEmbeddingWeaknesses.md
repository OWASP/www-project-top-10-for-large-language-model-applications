...
#### 3. هجمات عكس التضمين
  يمكن للمهاجمين استغلال الثغرات لعكس التضمينات (Invert Embeddings) واستعادة كميات كبيرة من المعلومات المصدرية، مما يعرّض سرية البيانات للخطر. (المراجع #3، #4)  
#### 4. هجمات تسميم البيانات
  يمكن أن يحدث تسميم البيانات (Data Poisoning) عن قصد من قِبل المهاجمين (المراجع #5، #6، #7) أو بشكل غير مقصود. وقد تنشأ البيانات المسمومة من مستخدمين داخليين، أو من التعليمات، أو من تهيئة البيانات (Data Seeding)، أو من موفري بيانات غير موثوقين، مما يؤدي إلى مخرجات متلاعب بها.
#### 5. تغيير السلوك
...
#### 2. التحقق من البيانات ومصادرها
  نفّذ مسارات تحقق قوية من مصادر البيانات. قم بتدقيق ومراجعة سلامة قاعدة البيانات بانتظام، بحثًا عن أكواد خفية أو هجمات تسميم بيانات. ولا تقبل البيانات إلا من مصادر موثوقة ومُوثقة.
#### 3.مراجعة البيانات عند الدمج والتصنيف
  عند دمج البيانات من مصادر متعددة، راجع مجموعة البيانات المجمعة بعناية. قم بوسم البيانات وتصنيفها داخل قاعدة البيانات للتحكم في مستويات الوصول، وتجنّب أخطاء عدم تطابق البيانات.
#### 4. المراقبة والتسجيل
