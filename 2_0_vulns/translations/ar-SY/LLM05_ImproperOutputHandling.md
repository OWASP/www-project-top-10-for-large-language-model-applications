## LLM05:2025 التعامل غير السليم مع المخرجات
...
#### السيناريو #1
  يستخدم التطبيق إضافة (Extension) مبنية على نموذج اللغة الكبير لتوليد استجابات لميزة الدردشة. تقدم هذه الإضافة أيضًا عددًا من الوظائف الإدارية المتاحة لنموذج لغة آخر يمتلك امتيازات إضافية. يمرر نموذج اللغة العام استجابته مباشرة إلى الإضافة، دون التحقق السليم من المخرجات، مما يتسبب في إيقاف الإضافة للصيانة.
#### السيناريو #2
  يستعمل المستخدم أداة تلخيص مواقع إلكترونية تعتمد على نموذج اللغة الكبير لإنشاء ملخص لمقال. تتضمن صفحة الموقع ثغرات حقن التعليمات (Prompt Injection) بحيث تطلب من النموذج استخراج محتوى حساس من الموقع أو من محادثة المستخدم. بعد ذلك، يمكن للنموذج ترميز البيانات الحساسة وإرسالها، دون تحقق أو تصفية، إلى خادم خاضع لسيطرة المهاجم.
  #### السيناريو #3
  يسمح نموذج اللغة الكبير للمستخدمين بإنشاء استعلامات SQL لقاعدة بيانات خلفية عبر ميزة شبيهة بالدردشة. يطلب المستخدم إنشاء استعلام لحذف جميع جداول قاعدة البيانات. إذا لم يتم فحص الاستعلام الذي أنشأه النموذج بشكل صحيح، فقد يتم حذف جميع جداول قاعدة البيانات فعلا.
#### السيناريو #4
