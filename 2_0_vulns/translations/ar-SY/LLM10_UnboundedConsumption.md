...
#### السيناريو #1: حجم إدخال غير منضبط
  يقوم المهاجم بإرسال مدخلات كبيرة بشكل غير معتاد إلى تطبيق نموذج اللغة الكبير الذي يعالج البيانات النصية، مما يؤدي إلى استخدام مفرط للذاكرة وحمل زائد على وحدة المعالجة المركزية (CPU)، وقد يتسبب ذلك في تعطل النظام أو إبطاء الخدمة بشكل كبير.
...
#### السيناريو #4: استنزاف المحفظة
  يقوم المهاجم بإنشاء عمليات مفرطة لاستغلال "نموذج الدفع مقابل الاستخدام" (pay-per-use model) لخدمات الذكاء الاصطناعي السحابية، مما يتسبب في تكاليف غير مستدامة لمزود الخدمة.
...
#### السيناريو #6: تجاوز تصفية مدخلات النظام
  يقوم المهاجم بتجاوز تقنيات تصفية المدخلات ومقدمات النموذج (Preambles) لتنفيذ هجوم القنوات الجانبية واسترجاع معلومات النموذج إلى مورد يتم التحكم به عن بُعد.
