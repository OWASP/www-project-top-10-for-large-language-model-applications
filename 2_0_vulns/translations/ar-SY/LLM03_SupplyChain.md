...
9. قم بتطبيق سياسة تحديث (patching policy) للتخفيف من مخاطر المكونات الضعيفة أو المتقادمة. تأكد من أن التطبيق يعتمد على إصدار مُدار من واجهة برمجة التطبيقات (APIs) والنموذج الأساسي.
10. قم بتشفير النماذج المنشورة على AI Edge باستخدام فحوصات السلامة، واستخدم واجهات برمجة التطبيقات الخاصة بإثبات الموردين (Vendor Attestation APIs) لمنع التطبيقات والنماذج المُعدّلة، وإنهاء تشغيل التطبيقات التي تحتوي على برامج ثابتة غير معترف بها.
...
#### السيناريو  #5: إختراق الأطراف الخارجية
  قيام جهة خارجية مخترقة بتقديم محول LoRA يحتوي على ثغرات بحيث يتم دمجه مع نموذج لغة كبير عبر خاصية دمج النماذج في منصة Hugging Face.
...
#### السيناريو  #7: هجمات CloudJacking و CloudBorne
