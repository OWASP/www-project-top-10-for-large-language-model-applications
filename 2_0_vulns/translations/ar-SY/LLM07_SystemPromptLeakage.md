...
#### السيناريو  #2
  يمتلك نموذج اللغة الكبير تعليمة نظام تمنع توليد محتوى مسيء، روابط خارجية، أو تنفيذ تعليمات برمجية. في هذه الحالة يقوم المهاجم باستخراج تعليمة النظام هذه، ثم يستخدم هجوم حقن التعليمات لتجاوز هذه التعليمة، مما يسهل تنفيذ هجوم تنفيذ تعليمات برمجية عن بُعد.
