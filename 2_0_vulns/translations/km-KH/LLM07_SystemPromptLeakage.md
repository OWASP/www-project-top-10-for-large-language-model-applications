...
ភាពងាយរងគ្រោះនៃការលេចធ្លាយ System Prompt នៅក្នុង LLMs សំដៅលើហានិភ័យដែល System Prompts ឬការណែនាំដែលប្រើដើម្បីដឹកនាំพฤติกรรมของโมเดล ក៏អាចមានព័ត៌មានរសើបដែលមិនមានបំណងให้ត្រូវបានរកឃើញផងដែរ។ System Prompts ត្រូវបានរចនាឡើងដើម្បីណែនាំលទ្ធផលរបស់គំរូទៅតាមតម្រូវការរបស់កម្មវិធី ប៉ុន្តែអាចមានផ្ទុកនូវความลับโดยអចេตนา។ នៅពេលត្រូវបានរកឃើញ ព័ត៌មាននេះអាចត្រូវបានប្រើដើម្បីសម្រួលដល់ការវាយប្រហារផ្សេងទៀត។

វាជារឿងសំខាន់ក្នុងការយល់ថា System Prompt មិនគួរត្រូវបានចាត់ទុកថាជាความลับនោះទេ ហើយក៏មិនគួរត្រូវបានប្រើជា security control ដែរ។ ដូច្នេះ ទិន្នន័យរសើបដូចជា credentials, connection strings ជាដើម មិនគួរត្រូវបានផ្ទុកនៅក្នុង System Prompt language នោះទេ។

ស្រដៀងគ្នានេះដែរ ប្រសិនបើ System Prompt មានព័ត៌មានដែលពិពណ៌នាអំពីតួនាទី និងការអនុញ្ញាតផ្សេងៗគ្នា ឬទិន្នន័យរសើបដូចជា connection strings ឬ passwords ខណៈដែលការเปิดเผยព័ត៌មានបែបនេះអាចមានប្រយោជន៍ ហានិភ័យសុវត្ថិភាពជាមូលដ្ឋានមិនមែនដោយសារតែព័ត៌មានទាំងនេះត្រូវបានเปิดเผยនោះទេ ប៉ុន្តែវាគឺថាកម្មវិធីអនុញ្ញាតឱ្យឆ្លងកាត់ការគ្រប់គ្រង session និង authorization checks រឹងមាំដោយការផ្ទេរទៅ LLM ហើយថាទិន្នន័យរសើបត្រូវបានរក្សាទុកនៅក្នុងកន្លែងដែលវាមិនគួរនៅ។

សរុបមក៖ ការเปิดเผย System Prompt ខ្លួនវាផ្ទាល់មិនបង្កឱ្យមានហានិភ័យពិតប្រាកដនោះទេ -- ហានិភ័យសុវត្ថិភាពស្ថិតនៅជាមួយធាតុផ្សំមូលដ្ឋាន មិនថាជាការเปิดเผยព័ត៌មានរសើប ការឆ្លងកាត់ System guardrails ការបំបែកសិទ្ធិមិនត្រឹមត្រូវជាដើម។ ទោះបីជាពាក្យពិតប្រាកដមិនត្រូវបានเปิดเผยក៏ដោយ អ្នកវាយប្រហារដែលទាក់ទងជាមួយប្រព័ន្ធស្ទើរតែប្រាកដជាអាចកំណត់ guardrails និង formatting restrictions ជាច្រើនដែលមាននៅក្នុង System Prompt language ក្នុងអំឡុងពេលប្រើប្រាស់កម្មវិធី ការផ្ញើសារទៅកាន់គំរូ និងការសង្កេតមើលលទ្ធផល។
