...
ភាពងាយរងគ្រោះនៃការលេចធ្លាយប្រព័ន្ធប្រាប់ (system prompt leakage vulnerability) នៅក្នុងម៉ូដែលភាសាធំៗ (LLMs) សំដៅលើហានិភ័យដែលប្រព័ន្ធប្រាប់ ឬការណែនាំដែលបានប្រើដើម្បីកំណត់ឥរិយាបថរបស់ម៉ូដែល អាចមានផ្ទុកនូវព័ត៌មានដែលមានលក្ខណៈសម្ងាត់ដែលមិនមានបំណងឱ្យត្រូវបានរកឃើញ។ ប្រព័ន្ធប្រាប់ (System Prompt)ត្រូវបានរចនាឡើងដើម្បីដឹកនាំលទ្ធផលរបស់ម៉ូដែលដោយផ្អែកលើតម្រូវការរបស់កម្មវិធី ប៉ុន្តែអាចមានផ្ទុកនូវសម្ងាត់ដោយចៃដន្យ។ នៅពេលដែលត្រូវបានរកឃើញ ព័ត៌មាននេះអាចត្រូវបានប្រើដើម្បីសម្របសម្រួលការវាយប្រហារផ្សេងទៀត។

វាជារឿងសំខាន់ដែលត្រូវយល់ថា ប្រព័ន្ធប្រាប់ (system prompt) មិនគួរត្រូវបានចាត់ទុកជាសម្ងាត់នោះទេ ហើយក៏មិនគួរត្រូវបានប្រើជាការគ្រប់គ្រងសន្តិសុខដែរ។ ដូច្នេះហើយ ទិន្នន័យរសើបដូចជា ព័ត៌មានសម្ងាត់ (credentials) ខ្សែតភ្ជាប់ (connection strings) និងអ្វីផ្សេងទៀត មិនគួរត្រូវបានដាក់បញ្ចូលនៅក្នុងភាសានៃប្រព័ន្ធប្រាប់នោះទេ។

ស្រដៀងគ្នានេះដែរ ប្រសិនបើ System Prompt មានព័ត៌មានដែលពិពណ៌នាអំពីតួនាទី និងការអនុញ្ញាតផ្សេងៗគ្នា ឬទិន្នន័យរសើបដូចជា connection strings ឬ passwords ខណៈដែលការបញ្ចូលព័ត៌មានបែបនេះអាចមានប្រយោជន៍ ហានិភ័យសុវត្ថិភាពជាមូលដ្ឋានមិនមែនដោយសារតែព័ត៌មានទាំងនេះត្រូវបានបញ្ចូលនោះទេ ប៉ុន្តែវាគឺថាកម្មវិធីអនុញ្ញាតឱ្យឆ្លងកាត់ការគ្រប់គ្រង session និង authorization checks រឹងមាំដោយការផ្ទេរទៅ LLM ហើយថាទិន្នន័យរសើបត្រូវបានរក្សាទុកនៅក្នុងកន្លែងដែលវាមិនគួរនៅ។

សរុបមក៖ ការបញ្ចូល System Prompt ខ្លួនវាផ្ទាល់មិនបង្កឱ្យមានហានិភ័យពិតប្រាកដនោះទេ ហានិភ័យសុវត្ថិភាពស្ថិតនៅជាមួយធាតុផ្សំមូលដ្ឋាន មិនថាជាការបញ្ចូលព័ត៌មានដែលមានលក្ខណៈសម្ងាត់ ការឆ្លងកាត់ System guardrails ការបំបែកសិទ្ធិមិនត្រឹមត្រូវជាដើម។ ទោះបីជាពាក្យពិតប្រាកដមិនត្រូវបានបញ្ចូលក៏ដោយ អ្នកវាយប្រហារដែលទាក់ទងជាមួយប្រព័ន្ធស្ទើរតែប្រាកដជាអាចកំណត់ guardrails និង formatting restrictions ជាច្រើនដែលមាននៅក្នុង System Prompt language ក្នុងអំឡុងពេលប្រើប្រាស់កម្មវិធី ការផ្ញើសារទៅកាន់គំរូ និងការសង្កេតមើលលទ្ធផល។

## ឧទាហរណ៍ទូទៅនៃហានិភ័យ

### ១. ការលាតត្រដាងមុខងាររសើប (Exposure of Sensitive Functionality)

System Prompt របស់កម្មវិធីអាចបង្ហាញព័ត៌មាន ឬមុខងាររសើបដែលត្រូវបានបម្រុងទុកឱ្យរក្សាការសម្ងាត់ ដូចជា sensitive system architecture, API keys, database credentials ឬ user tokens ។ ទាំងនេះអាចត្រូវបានទាញយក ឬប្រើប្រាស់ដោយអ្នកវាយប្រហារដើម្បីទទួលបានការចូលប្រើប្រាស់ដោយគ្មានការអនុញ្ញាតទៅក្នុងកម្មវិធី។ ឧទាហរណ៍ System Prompt ដែលមានប្រភេទ database ដែលប្រើសម្រាប់ tool អាចអនុញ្ញាតឱ្យអ្នកវាយប្រហារកំណត់គោលដៅសម្រាប់ការវាយប្រហារ SQL injection ។

### ២. ការលាតត្រដាងច្បាប់ផ្ទៃក្នុង (Exposure of Internal Rules)
...
#### ៣. ការបង្ហាញលក្ខណៈវិនិច្ឆ័យនៃការចម្រាញ់ (Revealing of Filtering Criteria)
...
>
#### ៤. ការលាតត្រដាង Permissions និង User Roles (Disclosure of Permissions and User Roles)
...
#### ១. បំបែកទិន្នន័យរសើបចេញពី System Prompts (Separate Sensitive Data from System Prompts)

ជៀសវាងការបង្កប់ព័ត៌មានដែលមានលក្ខណៈសម្ងាត់ណាមួយ (ឧទាហរណ៍ API keys, auth keys, database names, user roles, permission structure របស់ application) ដោយផ្ទាល់នៅក្នុង System Prompts ។ ផ្ទុយទៅវិញ សូម externalize ព័ត៌មានបែបនេះទៅកាន់ systems ដែល model មិនចូលប្រើដោយផ្ទាល់។

#### ២. ជៀសវាងការពឹងផ្អែកលើ System Prompts សម្រាប់ការគ្រប់គ្រង Behavior ដ៏តឹងរ៉ឹង (Avoid Reliance on System Prompts for Strict Behavior Control)
...
#### ៣. អនុវត្ត Guardrails (Implement Guardrails)
...
#### ៤. ធានាថា security controls ត្រូវបានអនុវត្តដោយឯករាជ្យពី LLM (Ensure that security controls are enforced independently from the LLM)
