...
### ១. ការជន់លិចដោយការបញ្ចូលដែលមានប្រវែងអថេរ (Variable-Length Input Flood)
...
### ២. ការបដិសេធកាបូបលុយ (Denial of Wallet - DoW)
...
### ៣. ការហូរហៀរការបញ្ចូលជាបន្តបន្ទាប់ (Continuous Input Overflow)
...
### ៤. សំណួរដែលប្រើប្រាស់ធនធានច្រើន (Resource-Intensive Queries)
...
### ៥. ការទាញយកគំរូតាមរយៈ API (Model Extraction via API)
...
#### ៦. ការចម្លង Model តាមមុខងារ (Functional Model Replication)
...
#### ៧. ការវាយប្រហារ Side-Channel (Side-Channel Attacks)
...
#### ១. ការផ្ទៀងផ្ទាត់ Input (Input Validation)

អនុវត្ត strict input validation ដើម្បីធានាថា inputs មិនលើសពី reasonable size limits ។

#### ២. កំណត់ការលាតត្រដាង Logits និង Logprobs (Limit Exposure of Logits and Logprobs)
...
#### ៩. ការកាត់បន្ថយដោយប្រក្រតី (Graceful Degradation)

រចនាប្រព័ន្ធដើម្បី degrade gracefully ក្រោម heavy load ដោយរក្សា partial functionality ជាជាង complete failure ។

#### ១០. កំណត់សកម្មភាពដែលបានតម្រង់ជួរ និង Scale ដោយភាពរឹងមាំ (Limit Queued Actions and Scale Robustly)
...
#### ១៣. ការគ្រប់គ្រងសិទ្ធិចូលប្រើ (Access Controls)
...
#### ១៤. ML Model Inventory កណ្តាល (Centralized ML Model Inventory)
...
#### សេណារីយ៉ូ #១: ទំហំ Input ដែលមិនមានការគ្រប់គ្រង (Uncontrolled Input Size)
...
#### សេណារីយ៉ូ #២: សំណើដដែលៗ (Repeated Requests)
...
#### សេណារីយ៉ូ #៣: Queries ដែលប្រើប្រាស់ធនធានច្រើន (Resource-Intensive Queries)
...
#### សេណារីយ៉ូ #៤: ការបដិសេធកាបូបលុយ (Denial of Wallet - DoW)
...
#### សេណារីយ៉ូ #៥: ការចម្លង Model តាមមុខងារ (Functional Model Replication)
...
#### សេណារីយ៉ូ #៦: ការឆ្លងកាត់ការចម្រាញ់ Input របស់ប្រព័ន្ធ (Bypassing System Input Filtering)
