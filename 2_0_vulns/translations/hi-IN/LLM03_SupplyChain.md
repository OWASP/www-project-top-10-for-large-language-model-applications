...
#### 2. Licensing से जुड़े जोखिम
  AI के  विकास में अक्सर विविध प्रकार के  software और डेटासेट  licenses शामिल होते हैंं, जो ठीक से संभले  नहीं जाने पर जोखिम पैदा कर सकते हैंं । विभिन्न open-source एवं proprietary licenses अलग-अलग कानूनी आवश्यकताओं के  साथ आते हैंं । डेटासेट licenses उपयोग (usage) , वितरण (distribution) तथा व्यावसायीकरण (commercialization) को प्रतिबंधित कर सकते हैंं ।
