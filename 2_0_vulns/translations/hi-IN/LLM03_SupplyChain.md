...
#### 6. Vulnerable LoRA adapters
  LoRA एक लोकप्रिय fine-tuning तकनीक हैं जो pre-trained परतों को मौजूदा LLM पर जोड़ने की अनुमति देकर modularity को बढ़ाती हैं। यह विधि दक्षता (efficiency) तो बढ़ाती हैं लेकिन नए जोखिमों भी पैदा हो जाते हैं, जहां एक दुर्भावनापूर्ण LoRA adapter pre-trained बेस मॉडल की अखंडता एवं सुरक्षा से compromise करता हैं। यह collaborative एवं model merge environments दोनों में हो सकता हैं, लेकिन vLMM एवं OpenLLM जैसे लोकप्रिय inference deployment platforms द्वारा भी LoRA के support को exploit किया जा सकता हैं जहां adapters को डाउनलोड करके deployed मॉडल पर लागू किया जा सकता हैं।
...
#### परिदृश्य#12: Dataset Poisoning
  एक हमलावर poison करता हे सार्वजनिक रूप से उपलब्ध डेटासेट को, जिससे की मॉडल की fine-tuning के दौरान उसमे back door बनाए जा सकते हैं। यह back door सूक्ष्म एवं गुप्त रूप से विभिन्न बाजारों में कुछ कंपनियों के प्रती पक्षधर करने के लिये प्रयोग में आते हैं।
