...
#### 1. Third-party Package से जुड़ी पारंपरिक vulnerabilities
  जैसें कि outdated या deprecated components, जिनका हमलावर (mallicious attacker) LLM applications को compromise करने के प्रयोग लेता हैंं । यह "A06:2021 – Vulnerable and Outdated Components" के जैसा हैं जब components का उपयोग मॉडल विकास या finetuning के दौरान होने से जोखिमों बद जाता हैं ।
