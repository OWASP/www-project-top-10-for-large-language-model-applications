...
#### 6.Sandbox तकनिकें
  ...
  नेटवर्क  संसाधनों, आंतरिक सेवाओं  एवं APIs तक LLM की पहूँच (access) को प्रतिबंधित करें । यह सभी सामान्य परिदृश्यों में विशेष रूप से महत्वपूर्ण हैं क्योंकि यह आंतरिक (insider) जोखिमों एवं खतरों (threats) को शामिल करता हैं । इसके  अलावा, यह LLM application को डेटा एवं संसाधनों के  लिए पहूँच (access) की सीमा को नियंत्रित करता हैं, जिससे की side-channel हमलों को कम कर सकते हैं ।
...
#### 10. कतारबद्ध कार्यों को सीमित करें एवं मजबूत रूप से स्केल करें
  ...
  अलग-अलग मांगों को संभालने एवं system के  consistent प्रदर्शन के  लिए Dynamic scaling एवं load balancing को शामिल करतें हुँए, कतारबद्ध कार्यों (queued actions) एवं  कुल  कार्यों (total actions) की संख्या पर प्रतिबंध लागू करें ।
